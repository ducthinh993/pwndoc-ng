export default {
    ...
    auditCharts: 'Audit Charts',
    allCharts: 'All Charts',
    severityCharts: 'Severity Charts',
    categoryCharts: 'Category Charts',
    detailedView: 'Detailed View',
    vulnerabilitySeverityDistribution: 'Vulnerability Severity Distribution',
    severityDistributionPie: 'Severity Distribution - Pie Chart',
    severityDistributionBar: 'Severity Distribution - Bar Chart',
    pentestFindings: 'Pentest Findings',
    ...
    chartLoadError: 'Error loading chart',
    retry: 'Retry',
    exportChart: 'Export Chart',
    noChartData: 'No Chart Data',
    noChartDataMessage: 'No vulnerability data available for chart display',
    pieChartAriaLabel: 'Pie chart displaying vulnerability distribution',
    barChartAriaLabel: 'Bar chart displaying vulnerability distribution',
  }
