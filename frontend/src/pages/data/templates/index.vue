  ...
  <div class="flex flex-col gap-6 p-6">
      ...
      <CardContent class="p-0">
        <div class="overflow-x-auto">
          <table class="w-full">
            <thead>
              <tr class="border-b">
                <th class="cursor-pointer p-4 text-left font-medium hover:bg-muted/50" @click="sortBy('name')">
                  {{ $t('name') }}
                  <ChevronUpIcon v-if="pagination.sortBy === 'name' && !pagination.descending" class="ml-1 inline size-4" />
                  <ChevronDownIcon v-if="pagination.sortBy === 'name' && pagination.descending" class="ml-1 inline size-4" />
                </th>
                <th class="cursor-pointer p-4 text-left font-medium hover:bg-muted/50" @click="sortBy('ext')">
                  {{ $t('extension') }}
                  <ChevronUpIcon v-if="pagination.sortBy === 'ext' && !pagination.descending" class="ml-1 inline size-4" />
                  <ChevronDownIcon v-if="pagination.sortBy === 'ext' && pagination.descending" class="ml-1 inline size-4" />
                </th>
                <th class="w-32 p-4 text-left font-medium">
                  {{ $t('actions') }}
                </th>
              </tr>
            </thead>
              ...
              >
                <td class="p-4">
                  <div class="flex items-center gap-2">
                    <DocumentIcon class="size-5 text-muted-foreground" />
                    {{ template.name }}
                  </div>
                </td>
                <td class="p-4">
                ...
                <td class="p-4">
                  <div class="flex gap-2">
                    ...
                    >
                      <ArrowDownTrayIcon class="size-4 text-blue-600" />
                    </Button>
                    <Button
      ...
      <DialogContent class="sm:max-w-[600px]">
        ...
        <form class="space-y-4" @submit.prevent="createTemplate">
          ...
          <div class="space-y-2">
            ...
            <div class="space-y-2">
              <div
                class="rounded-lg border-2 border-dashed border-muted-foreground/25 p-6 text-center transition-colors hover:border-muted-foreground/50"
              ...
              >
                ...
                <div v-if="!currentTemplate.file" class="flex flex-col items-center gap-2">
                  <CloudArrowUpIcon class="size-10 text-muted-foreground" />
                ...
                <div v-else class="flex items-center gap-2">
                  <DocumentIcon class="size-6 text-green-600" />
        ...
        <DialogFooter>
          ...
          >
            <LoadingSpinner v-if="creatingTemplate" class="mr-2 size-4" />
            {{ $t('btn.create') }}
          </Button>
        </DialogFooter>
      </DialogContent>
    ...
    <Dialog :open="showEditModal" @update:open="showEditModal = $event">
      <DialogContent class="sm:max-w-[600px]">
        ...
        <form class="space-y-4" @submit.prevent="updateTemplate">
          <div class="space-y-2">
        ...
        <DialogFooter>
          ...
          >
            <LoadingSpinner v-if="updatingTemplate" class="mr-2 size-4" />
            {{ $t('btn.update') }}
          </Button>
        </DialogFooter>
      </DialogContent>
    ...
    <Dialog :open="showDeleteModal" @update:open="showDeleteModal = $event">
      <DialogContent class="sm:max-w-[400px]">
        ...
        <DialogFooter>
          ...
          >
            <LoadingSpinner v-if="deletingTemplate" class="mr-2 size-4" />
            {{ $t('btn.confirm') }}
          </Button>
        </DialogFooter>
      </DialogContent>
